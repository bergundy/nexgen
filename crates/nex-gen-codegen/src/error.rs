...
//! the base layer (output plumbing + assembly + load/emit) needs. Front-ends
...
/// Errors produced by the base codegen layer.
#[derive(Debug, Error)]
pub enum Error {
    ...
    /// is the front-end's own diagnostic; the base does not interpret it.
