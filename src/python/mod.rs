...
use crate::spec::{ApiSpec, GeneratedModelSpec, OperationSpec, TypeReplacementSpec};
...
fn resolve_operation<'a>(
    ...
    let input_ref = normalized_python_type_ref(&input_message.full_name);
    ...
    let output_ref = normalized_python_type_ref(&output_message.full_name);
